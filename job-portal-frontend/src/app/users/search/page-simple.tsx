...
export default function UserSearchPage() {
  ...
  const searchUsers = async (page: number = 1, resetResults: boolean = true) => {
    if (resetResults) {
      setLoading(true)
      setUsers([])
      setCurrentPage(1)
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          ...
          {hasMore && !loadingMore && !loading && users.length > 0 && (
            <div className="flex justify-center mt-8">
              <button
                onClick={loadMore}
                className="bg-gray-800/50 hover:bg-gray-700/50 text-white px-6 py-3 rounded-lg transition-all border border-gray-600/50 hover:border-yellow-400/50"
              >
                Load More Users
              </button>
            </div>
