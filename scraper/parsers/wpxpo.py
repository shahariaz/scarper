...
logger = setup_logger("WPXPOParser")

class WPXPOJobParser(BaseJobParser):
    company = "WPXPO"
    url = "https://www.wpxpo.com/"

    def fetch_jobs(self) -> List[Dict]:
        client = HttpClient()
        jobs = []
        try:
            # Try main page and common career paths
            career_urls = [
                self.url,
                self.url + "careers/",
                self.url + "career/",
            ...
            logger.error(f"Error scraping WPXPO: {e}")
